    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the HOTS protocol have made
      ...
      return (
        <div>
          <p>Attention HOTS BurgerSwap LPs</p>
          <p>
            The only BurgerSwap pool that is compatible with HOTS is HOTS-BNB
          </p>
