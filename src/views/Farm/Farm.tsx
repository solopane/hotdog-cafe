...
const Farm: React.FC = () => {
  ...
  const { onRedeem } = useRedeem(getHotsMakerContract(hots))
  ...
  <StyledFarm>
    ...
    <Spacer size="lg" />
    <StyledInfo>
    Every time you stake and unstake LP tokens, the contract will automatically harvest HOTS rewards for you!
    </StyledInfo>
    <Spacer size="lg" />
    <StyledCardsWrapper>
</StyledCardsWrapper>
