...
import HotsMakerAbi from './abi/hotsmaker.json'
import HotsAbi from './abi/hots.json'
import PancakePairAbi from './abi/uni_v2_lp.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.hots = new this.web3.eth.Contract(HotsAbi)
    this.hotsMaker = new this.web3.eth.Contract(HotsMakerAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.hots, contractAddresses.hots[networkId])
    setProvider(this.hotsMaker, contractAddresses.hotsMaker[networkId])
  ...
  setDefaultAccount(account) {
    this.hots.options.from = account
    this.hotsMaker.options.from = account
  }
